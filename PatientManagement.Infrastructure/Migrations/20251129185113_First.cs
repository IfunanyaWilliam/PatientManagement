        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    Role = table.Column<int>(type: "int", nullable: false),
                    ProfessionalStatus = table.Column<int>(type: "int", nullable: false),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateModified = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrescriptionAuditTrail", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PrescriptionAuditTrail_Prescriptions_PrescriptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrescriptionAuditTrail_PrescriptionId",
                table: "PrescriptionAuditTrail",
