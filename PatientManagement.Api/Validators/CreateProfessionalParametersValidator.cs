...
namespace PatientManagement.Api.Validators
{
    ...
    public class CreateProfessionalParametersValidator : AbstractValidator<CreateProfessionalParameters>
    {
        public CreateProfessionalParametersValidator()
        {
            ...
            RuleFor(x => x.Qualification)
                ...
                .NotNull().WithMessage("Qualification cannot be null")
                .MinimumLength(2).WithMessage("Qualification must be at least 2 characters long")
                .MaximumLength(100).WithMessage("Qualification cannot exceed 100 characters");

            RuleFor(x => x.License)
                .Cascade(CascadeMode.Stop)
                .NotEmpty().WithMessage("License is required")
                .NotNull().WithMessage("License cannot be null")
                .MinimumLength(5).WithMessage("License must be at least 5 characters long")
